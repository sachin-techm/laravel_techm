                ...
                <div class="row">
                    <div class="col-8">
                        ...
                        <div class="form-group row validated">
                            ...
                            <div class="col-lg-9 col-md-9 col-sm-12">
                                <input type="organization" name="organization" value="{{ old('organization', $row->organization ?? '') }}" class="form-control" placeholder="Enter Organization" required />
                                @error('organization')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            </div>
                        ...
                        <div class="form-group row validated">
                            ...
                            <div class="col-lg-9 col-md-9 col-sm-12">
                                <textarea name="description" class="form-control" placeholder="Enter Description" required>{{ old('description', $row->description ?? '') }}</textarea>
                                @error('description')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            </div>
                        ...
                        <div class="form-group row validated">
                            ...
                            <div class="col-lg-9 col-md-9 col-sm-12">
                                <div class="image-input image-input-outline" id="testimonialImage" style="background-image: url({{ asset('assets/backend/media/users/blank.png') }})">
                                    @if(isset($row->image) && !empty($row->image))
                                        <div class="image-input-wrapper" style="background-image: url({{ asset('uploads/testimonials/thumbnails/250/'.$row->image) }})"></div>
                                    @else
