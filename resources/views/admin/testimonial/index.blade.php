				...
				<div class="card card-custom">
					<div class="card-header flex-wrap border-0 pt-6 pb-0">
						...
						<div class="card-toolbar">
							<a href="{{ route($moduleConfig['routes']['createRoute']) }}" class="btn btn-light-primary font-weight-bold ml-2"> <i class="flaticon2-plus icon-nm"></i>&nbsp;Add</a>
						</div>
					</div>
					<div class="card-body">
	...
	jQuery(document).ready((function () {
		...
		var columnsArray = [
			...
			},
			{
                ...
                title: "Image",
                template: function(t) {
                    return ( typeof t?.image != 'undefined' && t?.image)? '<img src="'+__BASE_URL_JS__+"uploads/testimonials/thumbnails/250/"+t?.image+'" style="height:50px" />' : 'N/A';
                }
            },
			{
				field: "name",
