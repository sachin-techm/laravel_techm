        ...
        <div class="card-body pt-4">
            ...
            <div class="py-9">
                <div class="d-flex align-items-center justify-content-between mb-2">
                    ...
                    <label >{{ isset(Auth::user()->role->name) ? Auth::user()->role->name : 'N/A' }}</label>
                </div>
                <div class="d-flex align-items-center justify-content-between mb-2">
            ...
            <div class="navi navi-bold navi-hover navi-active navi-link-rounded">
                ...
                <div class="navi-item mb-2">
                    <a href="{{ route('admin.profile.edit') }}" class="navi-link py-4 {{ request()->segment(3) == 'edit' ? 'active' : '' }}">
                ...
                <div class="navi-item mb-2">
                    <a href="{{ route('admin.profile.change_password') }}" class="navi-link py-4 {{ request()->segment(3) == 'change-password' ? 'active' : '' }}">
                        <span class="navi-icon mr-2">
                            <span class="svg-icon">
