                ...
                <div class="row">
                    <div class="col-8">
                        ...
                        <div class="form-group row validated">
                            ...
                            <div class="col-lg-9 col-md-9 col-sm-12">
                                <input type="text" name="time" value="{{ old('time', $row->time ?? '') }}" class="form-control" placeholder="Enter Time" required />
                                @error('time')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            </div>
                        ...
                        <div class="form-group row validated">
                            ...
                            <div class="col-lg-9 col-md-9 col-sm-12">
                                <textarea name="description" class="form-control summernote-editor" placeholder="Enter Description" required>{{ old('description', $row->description ?? '') }}</textarea>
                                @error('description')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            </div>
