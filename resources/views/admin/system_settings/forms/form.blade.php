            ...
            <div class="card-body">
                <div class="row">
                    ...
                    <div class="col-8">
                        ...
                        <div class="form-group row validated">
                            <label class="col-form-label col-lg-3 col-sm-12 text-lg-left">Value</label>
                            <div class="col-lg-9 col-md-9 col-sm-12">
                                <input type="text" name="value" value="{{ old('value') ? old('value') :( isset($row->value) ? $row->value : '') }}" class="form-control" required placeholder="Enter value"/>
                                @error('value')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            </div>
