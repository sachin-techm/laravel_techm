...
<head>
	...
	<link href="{{asset('assets/backend/plugins/global/plugins.bundlef552.css') }}" rel="stylesheet" type="text/css" />
	<link href="{{asset('assets/backend/css/style.bundlef552.css') }}" rel="stylesheet" type="text/css" />
	<!--end::Global Theme Styles-->
	<!--begin::Layout Themes(used by all pages)-->
	<link href="{{asset('assets/backend/css/themes/layout/header/base/lightf552.css') }}" rel="stylesheet" type="text/css" />
	<link href="{{asset('assets/backend/css/themes/layout/header/menu/lightf552.css') }}" rel="stylesheet" type="text/css" />
	<link href="{{asset('assets/backend/css/themes/layout/brand/darkf552.css') }}" rel="stylesheet" type="text/css" />
	<link href="{{asset('assets/backend/css/themes/layout/aside/darkf552.css') }}" rel="stylesheet" type="text/css" />
	<link rel="stylesheet" href="{{asset('assets/backend/plugins/custom/cropperjs/css/cropper.css') }}"/>
...
<body id="kt_body" class="header-fixed header-mobile-fixed subheader-enabled subheader-fixed aside-enabled aside-fixed aside-minimize-hoverable page-loading" style="background:#E5E5E5;">
	...
	<div id="kt_header_mobile" class="header-mobile align-items-center header-mobile-fixed">
		...
		<a href="{{ route('admin.dashboard') }}">
			@if(isset($adminSettings->logo) && !empty($adminSettings->logo))
				<img alt="Logo" class="img-fluid" style="height:55px" src="{{asset('/uploads/admins/logos/thumbnails/250/'.$adminSettings->logo)}}" />
				@else
					<img alt="Logo" class="img-fluid" style="height:55px" src="{{asset('assets/backend/media/logos/logo.png')}}" />
	        @endif
		</a>
		<!--end::Logo-->
		<!--begin::Toolbar-->
        ...
        <div class="d-flex flex-row flex-column-fluid page">
            ...
            <div class="aside aside-left aside-fixed d-flex flex-column flex-row-auto" id="kt_aside">
                ...
                <div class="brand flex-column-auto" id="kt_brand">
                    <!--begin::Logo-->
                    @if(isset($adminSettings->logo) && !empty($adminSettings->logo))
							<img alt="Logo" class="img-fluid" src="{{asset('/uploads/admins/logos/thumbnails/250/'.$adminSettings->logo)}}" style="width: 150px;" />
						@else
							<img alt="Logo" class="img-fluid" src="{{asset('assets/backend/media/logos/logo.png')}}" style="width: 150px;" />
				        @endif	
	...
	<script src="{{asset('assets/backend/plugins/global/plugins.bundlef552.js?v=7.1.8')}}"></script>
	<script src="{{asset('assets/backend/plugins/custom/prismjs/prismjs.bundlef552.js?v=7.1.8')}}"></script>
	<script src="{{asset('assets/backend/js/scripts.bundlef552.js?v=7.1.8')}}"></script>
	<script src="{{asset('assets/backend/js/widgetsf552.js?v=7.1.8')}}"></script>

	@if(\Route::currentRouteName() == 'admin.' || \Route::currentRouteName() == 'admin.dashboard')
	<script src="{{asset('assets/backend/plugins/custom/charts/amcharts/chartsf552.js?v=7.1.8')}}"></script>
	@endif

	<script src="{{asset('assets/backend/plugins/custom/cropperjs/js/cropper.js') }}"></script>
	<!-- <script src="{{asset('assets/backend/plugins/custom/cropper/cropper.js') }}"></script> -->

	<link rel="stylesheet" href="{{asset('assets/backend/plugins/custom/eqneditor_CK5/build/ckeditor5.css?v=7.1.8')}}">
	<script src="{{asset('assets/backend/plugins/custom/eqneditor_CK5/build/ckeditor.js?v=7.1.8')}}"></script>
	<script src="{{asset('js/ckfinder_core/ckfinder.js?v=7.1.9')}}"></script>


    <!-- Custom Scripts -->
    <script src="{{asset('assets/backend/js/custom/index.js')}}"></script>
