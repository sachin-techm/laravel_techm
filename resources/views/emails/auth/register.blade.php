                        ...
                        <table role="presentation" border="0" cellpadding="0" cellspacing="0" class="main">
                            ...
                            <tr>
                                <td class="wrapper">
                                    ...
                                    <p>Thanks for signing up a K-Shala account with your email {{$user->email}}.</p>
                                    <p>Now you can use K-Shala for Course and Test.</p>
                                    <p>Support Center: <a href="{{ env('SUPPORT_URL') }}">{{ env('SUPPORT_URL') }}</a> </p><br>
                                    ...
                                    <p> <small>Please do not reply to this email directly. If you need any help, please contact our support team and we will do our best to resolve your concerns!</small> </p>
                            ...
                            <table role="presentation" border="0" cellpadding="0" cellspacing="0">
                                <tr>
                                    <td class="content-block">
                                        <span class="apple-link">{{ env('APP_NAME') }} © {{now()->format("Y")}}
                                    </td>
                                </tr>
                            </table>
                        </div>
