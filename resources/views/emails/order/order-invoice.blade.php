                        ...
                        <table role="presentation" border="0" cellpadding="0" cellspacing="0" class="main">
                            ...
                            <tr>
                                <td class="wrapper">
                                    ...
                                    <p>Thanks for using {{ env('APP_NAME') }}. Your {{ $order->type == 1 ? 'Course' : 'Test' }} <b>{{ $order->type == 1 ? $order->course->course_name : $order->questionSet->set_name }}</b> has been successfully purchased.</p>
                                                ...
                                                <td align="left">
                                                    <table role="presentation" border="0" cellpadding="0" cellspacing="0">
                                                        <tbody>
                                                            <tr>
                                                            	@if($order->type == 1)
                                                                <td> <a href="{{ env('APP_SHARABLE_URL') }}/course/{{ $order->course->id }}" target="_blank">Course Details</a> </td>
                                                                @else
                                                                <td> <a href="{{ env('APP_SHARABLE_URL') }}/test/{{ $order->questionSet->id }}" target="_blank">Test Details</a> </td>
                                                                @endif
                                                            </tr>
                                                        </tbody>
                                                    </table>
                                    ...
                                    <table role="presentation" border="0" cellpadding="0" cellspacing="0" class="btn btn-primary">
                                        <tbody>
                                            <tr>
                                                ...
                                                <td align="right">
                                                    {{ $order->type == 1 ? 'Course' : 'Test' }}
                                                </td>
                                            </tr>

                                            <tr>
                                                <td align="left">
                                                    {{ \Helper::getDateFromFormat2($order->created_at) }}
                                                </td>
                                                <td align="right">
                                                    <span style="font-size: 25px; font-weight: 700">₹{{ number_format($order->total_amount, 2) }}</span>
                                                </td>
                                            </tr>
                                        </tbody>
                                    </table>
                                    ...
                                    <table role="presentation" border="0" cellpadding="0" cellspacing="0" class="btn btn-primary">
                                        <tbody>
                                            ...
                                            @if($order->coupon_id && $order->coupon_code && $order->coupon_amount)
                                            <tr>
                                                <td align="left">
                                                    Coupon Amount
                                                </td>
                                            ...
                                            <tr>
                                                ...
                                                <td align="right">
                                                    ₹{{ number_format($order->wallet_used_amount, 2) }}
                                                </td>
                                            </tr>
                                            @endif
