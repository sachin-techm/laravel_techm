...
class RolePermission extends MasterModel
{
    use HasFactory;
    use SoftDeletes;
    ...
    public function setPermissionDataAttribute($value){
    
        $this->attributes['permission_data'] = json_encode($value);
    }

    public function getPermissionDataAttribute($value){
