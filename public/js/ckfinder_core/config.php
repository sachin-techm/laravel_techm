...
$config['licenseName'] = '';
$config['licenseKey']  = '*W?Y-*1**-Z**R-*1**-*R**-1*H*-3**8'; // https://admin.gualy.com.uy/assets/js/ckfinder/ckfinder_keygen.html
// $config['licenseKey']  = 'UD7DUM8NYAEX7Z66BSBS493EYP2J3'; // https://charmevietnam.com/Common/CkfinderKey?srsltid=AfmBOory1tShG_a5L5U0IVfCh9Pvu8TDatRN7AgyoHkoqDtlkAETXuns
// $config['licenseKey']  = 'FMHM1RKGEP4NTF1D3D1Y47ESV8JJH'; // https://charmevietnam.com/Common/CkfinderKey?srsltid=AfmBOory1tShG_a5L5U0IVfCh9Pvu8TDatRN7AgyoHkoqDtlkAETXuns
...
$config['backends'][] = array(
    'name'         => 'default',
    'adapter'      => 'local',
    'baseUrl'      => base_url().'/userfiles/',
    'root'         => '/home/jo0xx0vc325v/public_html/kshala/public/userfiles', // Can be used to explicitly set the CKFinder user files directory.
    'chmodFiles'   => 0777,
    'chmodFolders' => 0755,
