                    ...
                    autoHide: function() {
                        ...
                        setTimeout((function() {
                            ...
                            t(o.table).find(".datatable-cell").show(), t(o.tableBody).each((function() {
                                ...
                                for (var a = 0, n = t(this)[0].offsetWidth, r = t(this)[0].scrollWidth; n < r && r - n > l.cellOffset && a < i.columns.length;) n = t(this)[0].offsetWidth, r = t(this)[0].scrollWidth, t(o.table).find(".datatable-row").each((function(a) {
...
var KTLayoutAsideMenu = function() {
    ...
    return {
        ...
        init: function(n) {
            ...
            (t = KTUtil.getBody(), e = KTUtil.getById(n)) && (o = "1" === KTUtil.attr(e, "data-menu-dropdown") ? "dropdown" : "accordion", "1" === KTUtil.attr(e, "data-menu-scroll") && (i = {
                ...
                height: function() {
                    ...
                    return KTUtil.isBreakpointUp("lg") && (t -= KTLayoutBrand.getHeight()), t - (parseInt(KTUtil.css(e, "marginBottom")) + parseInt(KTUtil.css(e, "marginTop")))
            ...
            }), KTUtil.hasClass(t, "aside-fixed") && KTUtil.hasClass(t, "aside-minimize-hoverable") && (KTUtil.addEvent(e, "mouseenter", (function(e) {

                e.preventDefault(), !1 !== KTUtil.isBreakpointUp("lg") && (r && (clearTimeout(r), r = null), l && (clearTimeout(l), l = null), l = setTimeout((function() {

                    KTUtil.hasClass(t, "aside-minimize") && KTUtil.isBreakpointUp("lg") && (KTUtil.addClass(t, "aside-minimize-hover"), KTLayoutAsideMenu.getMenu().scrollUpdate(), KTLayoutAsideMenu.getMenu().scrollTop())

                }), 50))

            })), KTUtil.addEvent(KTLayoutAside.getElement(), "mouseleave", (function(e) {

                e.preventDefault(), !1 !== KTUtil.isBreakpointUp("lg") && (l && (clearTimeout(l), l = null), r && (clearTimeout(r), r = null), r = setTimeout((function() {

                    KTUtil.hasClass(t, "aside-minimize-hover") && KTUtil.isBreakpointUp("lg") && (KTUtil.removeClass(t, "aside-minimize-hover"), KTLayoutAsideMenu.getMenu().scrollUpdate(), KTLayoutAsideMenu.getMenu().scrollTop())
        ...
        pauseDropdownHover: function(t) {
            ...
            a && a.pauseDropdownHover(t)

        },

        closeMobileOffcanvas: function() {

            a && KTUtil.isMobileDevice() && a.hide()
    ...
    return {
        ...
        init: function(n) {
            ...
            e = KTUtil.getById(n), t = KTUtil.getBody(), e && ((a = new KTToggle(e, t, {
                ...
                void 0 !== KTLayoutStickyCard && KTLayoutStickyCard.update(), void 0 !== KTLayoutHeaderMenu && KTLayoutHeaderMenu.pauseDropdownHover(800), void 0 !== KTLayoutAsideMenu && KTLayoutAsideMenu.pauseDropdownHover(800), KTCookie.setCookie("kt_aside_toggle_state", t.getState())

            })), a.on("beforeToggle", (function(e) {

                !1 === KTUtil.hasClass(t, "aside-minimize") && KTUtil.hasClass(t, "aside-minimize-hover") && KTUtil.removeClass(t, "aside-minimize-hover")
...
var KTLayoutAside = function() {
    ...
    return {
        ...
        init: function(n) {
            ...
            (e = KTUtil.getById(n), t = KTUtil.getBody(), e) && (i = KTUtil.hasClass(e, "aside-offcanvas-default") ? "aside-offcanvas-default" : "aside", a = new KTOffcanvas(e, {
        ...
        isFixed: function() {
            ...
            return KTUtil.hasClass(t, "aside-fixed")

        },

        isMinimized: function() {

            return KTUtil.hasClass(t, "aside-fixed") && KTUtil.hasClass(t, "aside-minimize")

        },

        isHoverable: function() {

            return KTUtil.hasClass(t, "aside-fixed") && KTUtil.hasClass(t, "aside-minimize-hoverable")
...
"undefined" != typeof module && (module.exports = KTLayoutBrand);
    ...
    return {
        ...
        init: function(i, o) {
            ...
            t = KTUtil.getById(i), a = KTUtil.getById(o), t && (n = new KTOffcanvas(a, {
                ...
                KTUtil.isBreakpointDown("lg") && n.hide()
...
"undefined" != typeof module && (module.exports = KTLayoutHeaderMenu);
...
"undefined" != typeof module && (module.exports = KTLayoutHeaderTopbar);
...
var KTLayoutHeader = function() {
    ...
    return {
        ...
        init: function(a, n) {
            ...
            t = KTUtil.getById(a), e = KTUtil.getById(n)
...
"undefined" != typeof module && (module.exports = KTLayoutHeader);
