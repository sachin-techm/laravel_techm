...
#### CodeCogs Extra Instuctions

# Download repo from git (https://github.com/ckeditor/ckeditor5-build-classic)
git clone 

npm install @codecogs/eqneditor-ckeditor5

# Install NPM packages
npm install stylelint@latest --save-dev
npm install postcss-unique-selectors@latest stylehacks@latest sugarss@latest
npm install
...
# Install Equation Editor NPM package
npm install @codecogs/eqneditor-ckeditor5


# Edit src/ckeditor.js
  - Add EqnEditor5 to toolbar: { items: [...]}
